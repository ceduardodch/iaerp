...
| Codex (este hilo, refresco SRI mensual) | 🚀 LISTA PARA PROMOCIÓN | Cada día consulta el mes actual completo y el día 1 también el anterior. REST/MCP validan año+mes; evidencia y comprobantes se deduplican en el servicio, y una recuperación XML en cola se amplía sin devolver 409. Ruff, mypy, 43 pruebas dirigidas, contratos y 23 huellas MCP verdes; revisión cruzada SRI/MCP en GO. La automatización quedó actualizada y pausada hasta verificar el despliegue. | 2026-08-31 |
