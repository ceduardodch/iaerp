...
| Codex (este hilo, SRI multiempresa) | ✅ EN MAIN | `--all` procesa DATA-CLIP y BTOB SAS con RUC/clave, cuenta IAERP y perfil de Chrome separados. Corrida real: 468 registros en DATA-CLIP y 18 en BTOB; ambas encolaron XML. Tarea diaria activa a las 08:00. PR `#71`, merge `b2154d9`; CI de `main` y sincronización de `release` verdes. | 2026-08-31 |
