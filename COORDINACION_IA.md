...
| Codex (este hilo) | 🟢 ACTIVA | Corrección de firma fiscal: IAERP pasa de XML-DSig básico a XAdES-BES compatible con Sky Franquicia; cambios acotados a `backend/app/services/signing.py`, dependencias y pruebas de firma | 2026-07-30 |
