...
| Codex (este hilo, SRI multiempresa) | 🚀 EN PROMOCIÓN | `--all` procesa DATA-CLIP y BTOB SAS con RUC/clave, cuenta IAERP y perfil de Chrome separados. Corrida real: 468 registros en DATA-CLIP y 18 en BTOB; ambas encolaron XML. Tarea diaria activa a las 08:00. Promoción a `main` autorizada. | 2026-08-31 |
