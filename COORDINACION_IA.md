...
| Claude (tarea programada `nomina-loop`) | ✅ COMPLETA | `PayrollPage.tsx` (`frontend/src/components/payroll/`) con pestañas Empleados y Roles, mismo patrón `Erp*` que `PurchasesPage.tsx`; sin ruta ni entrada de menú todavía (siguiente pendiente es el cableado en Sidebar/App/navigation, y después el E2E). tsc/oxlint/build verdes | 2026-08-22 |
