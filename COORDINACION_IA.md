...
| Codex (este hilo, reportes SRI diarios) | 🚀 EN PROMOCIÓN | Flujo local consulta ayer; REST/MCP importa de 1 a 5 TXT ya cargados y encola recuperación XML con tenant, fecha, política, idempotencia y auditoría. El commit se separa de `ops.*`; publicación a `main` autorizada por el humano. | 2026-08-31 |
